...
const contactItems = [
  { icon: Mail, label: "Email", value: "hello@youragency.com", href: "mailto:hello@youragency.com" },
  { icon: Phone, label: "Phone", value: "+880 1XXXXXXXXX", href: "tel:+8801XXXXXXXXX" },
...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (!formData.message.trim()) nextErrors.message = "Tell us a little about the project.";
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="mt-10 grid gap-4">
            {contactItems.map((item) => {
              ...
              return (
                ...
                >
                  <span className="grid h-12 w-12 place-items-center rounded-2xl bg-acid text-ink">
        ...
        >
          <div className="grid gap-5 md:grid-cols-2">
            <Field label="Name" name="name" value={formData.name} error={errors.name} onChange={handleChange} required />
            <Field label="Email" name="email" type="email" value={formData.email} error={errors.email} onChange={handleChange} required />
          ...
          <Button type="submit" className="mt-6 bg-acid text-ink hover:bg-white">
            Send Message
          </Button>
        </form>
      </div>
